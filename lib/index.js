  ...
  _createClass(AutoLinkText, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'span',
        null,
        (_context = (_context = (_context = (0, _match_parser2['default'])(text), prepareElements).call(_context, text, target, this.props.maxLinkLength), truncate).call(_context, this.props.maxLength), keyElements).call(_context)
      );
    }
  }]);
...
function prepareElements(text, target, maxLinkLength) {
  ...
  this.forEach(function (match) {
    ...
    elements.push(_react2['default'].createElement(
      ...
      truncateString(match.getAnchorText(), maxLinkLength)
    ));
